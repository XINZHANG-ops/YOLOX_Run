...
from yolox.data.datasets import LINMAO_CLASSES
...
#         print('###############')
        ...
        if save_result:
            ...
            save_txt_name = os.path.join(save_folder, 'labels' ,img_info['file_name'].split('.')[0]+'.txt')
...
def main(exp, args):
    ...
    predictor = Predictor(
        model, exp, LINMAO_CLASSES, trt_file, decoder,
